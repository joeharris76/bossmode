...
INSERT INTO tasks(
    ...
    'task_v3', 'Historical task', 'Migrate', 'Preserve every record',
    'failed', '{}', 'then', 'then'
);
INSERT INTO runs(
    ...
    'run_v3', 'task_v3', 'worker', 'finished', 'failed', 'historical run',
    '[]', 0, 'then', 'then'
);
INSERT INTO herdr_bindings(
    run_id, herdr_session, worker_name, agent_kind, status, bound_at, reconciled_at
) VALUES ('run_v3', 'bossmode', 'worker_v3', 'codex', 'stale', 'then', 'then');
INSERT INTO run_turns(
    id, run_id, ordinal, purpose, prompt_digest, artifact_path, status,
    summary, started_at, finished_at, result_json
) VALUES (
    'turn_v3', 'run_v3', 1, 'task', 'digest', '.bossmode/turns/turn_v3.json',
    'succeeded', 'preserved', 'then', 'then',
    '{"turn_id":"turn_v3","status":"succeeded","summary":"preserved","artifacts":[]}'
);
INSERT INTO evaluations(
    id, task_id, run_id, evaluator, passed, evidence, created_at
) VALUES ('eval_v3', 'task_v3', 'run_v3', 'reviewer', 0, 'historical evidence', 'then');
INSERT INTO feedback(
    id, task_id, run_id, kind, recurrence_key, content, created_at
) VALUES (
    'feedback_v3', 'task_v3', 'run_v3', 'failure',
...
INSERT INTO promotions(
    ...
    'promotion_v3', 'historical.failure', 'control', 'proposed',
